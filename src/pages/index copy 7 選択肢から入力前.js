...
export default function Home() {
  ...
  // エディタの初期コードリスト
  // [インデックス] {プログラム名, 備考, コード, 問題文, 一行に選択肢を何個置くか}
  const problems = [
    // [0]  サンプル問題1 
    ["サンプル問題1",
      "変数の代入",
...
`,
  ...
  // 問題文の"空欄"表示方法                                                               完了
  //  {} で配列の値として扱うルール
  // 全ての行を実行などのメッセージも解答結果などと統一する？
  // 一行に選択肢を何個置くかを決める値をリストに持たせる？                                  完了
  // "="で代入など疑似言語ではない構文を使えるようにするか 
  // 選択肢からボタンで空欄に入力する機能を実装、あるいは入力が要らないように問題を改変する？

  // 差し替え内容をリストにして、登録しておけば、ボタンから入力できる？　　　　[選択肢の番号][{内容, 行番号}]
    ...
    <div style={{ display: 'flex', gap: '1rem' }}>
      ...
      <div
        ...
        <div style={{height: 380}}>
          <VariablesPanel globalVars={globalVars} callStack={callStack} problemText={problemText} answerChoices={answerChoices} choiceitemsRow={choiceitemsRow}/>
        </div>
