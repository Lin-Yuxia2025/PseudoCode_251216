...
tokens = ('CIRCLE', 'TYPE', 'ARRAY', 'VALUE', 'END', 'NAME', 'NUMBER', 'COLON', 'EQUAL', 'ASSIGN', 'ADD', 'PLUS',
        'MINUS', 'MULTI', 'OUT', 'INCREASE', 'RESULT', 'ARR_LEN', 'WO', 'NO', 'NI', 'KARA', 'MADE', 'ZUTSU',  'L_S_BRACKET',
...
# valueにまとめる形にしたため、個別に代入処理を作る必要がなくなった

# 減算代入 （変数名 ← 変数名 - 数値) 変数 - 数値のみ
# def p_minus(p):
